"""
Kaggle inference script for Approach-04b.
...
Output
------
  data/processed/approach04b/predictions.csv  — Id, Predictions
"""
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Approach-04b Kaggle inference")
    p.add_argument(
        "--threshold", type=float, default=None,
        help="Override learned threshold (default: use models/approach04b/threshold.json)",
    )
    p.add_argument(
